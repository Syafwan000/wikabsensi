        ...
        <div class="card-body p-5">
            ...
            <form action="/dashboard/admin/rayon" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('rayon') is-invalid @enderror" name="rayon" placeholder="Rayon">
                    @error('rayon')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('pembimbing_rayon') is-invalid @enderror" name="pembimbing_rayon" placeholder="Pembimbing Rayon">
