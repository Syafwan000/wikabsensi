          ...
          <table class="table align-items-center mb-0">
            ...
            @foreach ($admins as $admin)                    
              <tr>
                ...
                <td>
                    <p class="text-xs font-weight-bold mb-0 ps-2">Admin</p>
                </td>
                <td>
                  <a href="#" class="btn bg-gradient-info mx-2 my-2 font-weight-bold text-xs">
                    Edit
                  </a>
                  <a href="#" class="btn bg-gradient-danger my-2 font-weight-bold text-xs">
                    Hapus
                  </a>
                </td>
             </tr>
